...
train_mix_scp = 'scp_ss_8k_both_libri/tr_mix.scp'
train_s1_scp = 'scp_ss_8k_both_libri/tr_s1.scp'
train_s2_scp = 'scp_ss_8k_both_libri/tr_s2.scp'

train_mix = f'{LIBRIMIX_BASE}/train-100/mix_both'
...
test_mix_scp = 'scp_ss_8k_both_libri/tt_mix.scp'
test_s1_scp = 'scp_ss_8k_both_libri/tt_s1.scp'
test_s2_scp = 'scp_ss_8k_both_libri/tt_s2.scp'

test_mix = f'{LIBRIMIX_BASE}/test/mix_both'
...
cv_mix_scp = 'scp_ss_8k_both_libri/cv_mix.scp'
cv_s1_scp = 'scp_ss_8k_both_libri/cv_s1.scp'
cv_s2_scp = 'scp_ss_8k_both_libri/cv_s2.scp'
